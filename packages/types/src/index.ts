...
export type Settings = { projectId: string; ttsEnabled: boolean; ttsMaxLength: number; ttsRate: number; ttsVoice?: string; volume: number; queueLimit: number; developerMode: boolean; allowMockEvents: boolean; userToken?: string };
