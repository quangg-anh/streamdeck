...
import { Brand, Empty, Notice, request } from "./components/studio-ui";
...
export default function Home() {
  ...
  if (loading) return <main className="app-shell" lang="vi"><nav className="topbar"><Brand suffix="STUDIO" /></nav><Empty>Đang tải…</Empty></main>;
  if (!me) return <main className="app-shell" lang="vi"><nav className="topbar"><Brand suffix="STUDIO" /></nav><Notice error={error || "Phiên đăng nhập hết hạn."} status="" /><Empty><a className="button-link" href="/login">Đến trang đăng nhập</a></Empty></main>;
